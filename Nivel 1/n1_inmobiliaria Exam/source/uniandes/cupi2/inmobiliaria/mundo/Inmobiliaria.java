...
public class Inmobiliaria
{
 ...
 // TODO Declarar el atributo para modelar la mansión número 3.
    ...
    {
        return "Mansión 1: "+ mansion1.darNumArboles() + " árboles. Bono relativo = " + descuentoRelativoMansion1() + '\n' +
        		"Mansión 2: "+ mansion2.darNumArboles() + " árboles. Bono relativo = " + descuentoRelativoMansion2() + '\n' + 
        		"Mansión 3: "+ mansion3.darNumArboles() + " árboles. Bono relativo = " + descuentoRelativoMansion3();
    }
    ...
    {
        return "Mansión 1: "+ mansion1.darNumArboles() + " árboles. Bono ecologico = " + mansion1.calcularBonoEcologico() + '\n' +
        		"Mansión 2: "+ mansion2.darNumArboles() + " árboles. Bono ecologico = " + mansion2.calcularBonoEcologico() + '\n' + 
        		"Mansión 3: "+ mansion3.darNumArboles() + " árboles. Bono ecologico = " + mansion3.calcularBonoEcologico();
    }
}