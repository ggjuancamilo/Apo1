...
public class PanelDios extends JPanel implements ActionListener
{
	...
	public PanelDios(InterazVisorMitologias pPrincipal)
	{
		...
		posicionDios = new JLabel("Posición");
		tPosicion = new JLabel();
		...
		// Cambio
		aux2a.add(posicionDios);
		aux2a.add(tPosicion);
		aux2a.setLayout(new GridLayout(3,2));
	...
	public void actualizar(Dios dios)
	{
		...
		descripcionDios.setText(textoFormato);
		//CAmbio
		tPosicion.setText("( " + mitologia.darPosicionDiosActual() + " / " + mitologia.darTotalDioses() + " )");
