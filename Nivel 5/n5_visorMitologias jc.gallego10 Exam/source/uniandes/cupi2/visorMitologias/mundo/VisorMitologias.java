...
{   
	...
	/**
	 * retorna la posicion de la mitologia actual
	 * @return Posicion de la mitologia actual
	 */
	public int darPosicionMitologiaActual()
	{
		return posicionMitologiaActual + 1 ;

	}

	/**
	 * retorna Cantidad de mitologias
	 * @return Cantidad de mitologias
	 */
	public int darTotalMitologias()
	{
		return mitologias.size();
	...
	/**
	 * retorna la mitologia con mas dioses
	 * @return mitologia con mas dioses
	 */
	public Mitologia darMitologiaConMasDioses ()
	{
		int pos = 0;
		Mitologia mit;
		for (int i = 0; i < mitologias.size()-1; i++) 
		{
			
			if (((Mitologia) mitologias.get(i)).darTotalDioses() < ((Mitologia) mitologias.get(i+1)).darTotalDioses() )
			{
				pos = i+1;
			}
		}

		return (Mitologia) mitologias.get(pos);
	}
	...
	{
		return "la mitologia con mas dioses es la " + darMitologiaConMasDioses().darNombre();
	}
