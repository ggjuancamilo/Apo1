...
public class Planeta
{
    ...
    /**
     * Retorna el numero de satelites densos que tiene un planeta.
     * @param pDensidad densidadinmediatemente menor para que un satelite natural sea denso.
     * @return Numero de planetas densos.
     */
    public int darNumeroSatelitesDensos(double pDensidad)
    {
    	int contador = 0;
    	for (int i = 0; i < satelitesNaturales.size(); i++) 
    	{
    		if(satelitesNaturales.get(i).darDensidad() > pDensidad)
    		{
    			contador++;
    		}
		}
